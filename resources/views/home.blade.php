        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <p class="hero-subtitle">Discover a world where every page brings a new adventure.<br>At Paper Haven, we
                        curate a diverse collection of books.</p>
                ...
                @foreach ($recommendedBooks as $book)
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="book-card position-relative">
                            <button type="button" class="heart-btn" onclick="toggleWishlist({{ $book->id }}, this)"
                            ...
                            <a href="{{ route('books.show', $book->id) }}">
                                <img src="{{ asset('images/books/' . $book->image) }}" alt="{{ $book->title }}"
                                    class="book-image" data-isbn="{{ $book->isbn }}" data-title="{{ $book->title }}"
